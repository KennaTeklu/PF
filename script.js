...
async function generateNextWorkout() {
  ...
  try {
    ...
    // Combined global readiness (caps 0.3–1.1)
    ...
    // Remove duplicates and primary muscles
    ...
    for (const muscleName of allTargetMuscles) {
      const candidates = muscleToExercises[muscleName] || [];
